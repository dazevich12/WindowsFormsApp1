...
namespace WindowsFormsApp1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class InvoiceDataTable : global::System.Data.TypedTableBase<InvoiceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public InvoiceRow AddInvoiceRow(string date, string client, string money) {
        ...
        public partial class InvoiceRow : global::System.Data.DataRow {
            ...
            public string money {
                get {
                    return ((string)(this[this.tableInvoice.moneyColumn]));
                }
                set {
                    this[this.tableInvoice.moneyColumn] = value;
                }
            }
        }
    ...
    public partial class InvoiceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Invoice] WHERE (([Id] = @Original_Id) AND ([date] = @Original_" +
                "date) AND ([client] = @Original_client) AND ([money] = @Original_money))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Invoice] ([date], [client], [money]) VALUES (@date, @client, @" +
                "money);\r\nSELECT Id, date, client, money FROM Invoice WHERE (Id = SCOPE_IDENTITY(" +
                "))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Invoice] SET [date] = @date, [client] = @client, [money] = @money WHERE (([Id] = @Original_Id) AND ([date] = @Original_date) AND ([client] = @Original_client) AND ([money] = @Original_money));
SELECT Id, date, client, money FROM Invoice WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, date, client, money FROM dbo.Invoice";
        ...
        public virtual int Delete(int Original_Id, string Original_date, string Original_client, string Original_money) {
        ...
        public virtual int Insert(string date, string client, string money) {
            if ((date == null)) {
        ...
        public virtual int Update(string date, string client, string money, int Original_Id, string Original_date, string Original_client, string Original_money, int Id) {
            if ((date == null)) {
                throw new global::System.ArgumentNullException("date");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string date, string client, string money, int Original_Id, string Original_date, string Original_client, string Original_money) {
            return this.Update(date, client, money, Original_Id, Original_date, Original_client, Original_money, Original_Id);
        }
    }
